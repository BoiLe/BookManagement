...
$ma = $_GET['skm_ms'];
$sqlSelect = "SELECT * FROM `sachkhuyenmai` WHERE MASACH='$ma';";
...
if(isset($_POST['btnSave'])) 
{
    ...
    // Câu lệnh UPDATE
    $sql = "UPDATE `sachkhuyenmai` SET MUCGIAMGIA='$mucgiamgia' WHERE MASACH='$ma';";
...
echo $twig->render('backend/sachkhuyenmai/edit.html.twig', ['sachkhuyenmai' => $loaisanphamRow] );