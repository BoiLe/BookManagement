...
$ma = $_GET['k_ms'];
$sqlSelect = "SELECT * FROM `kho` WHERE MASACH='$ma';";
...
if(isset($_POST['btnSave'])) 
{
    ...
    // Câu lệnh UPDATE
    $sql = "UPDATE `kho` SET TONGSOLUONG='$tongsoluong', SOLUONGCON='$soluongcon' WHERE MASACH='$ma';";
...
echo $twig->render('backend/kho/edit.html.twig', ['kho' => $loaisanphamRow] );