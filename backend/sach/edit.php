...
$ma = $_GET['s_ms'];
$sqlSelect = "SELECT * FROM `sach` WHERE MASACH='$ma';";
...
if(isset($_POST['btnSave'])) 
{
    ...
    // Câu lệnh UPDATE
    $sql = "UPDATE `sach` SET TENSACH='$ten', HINHANHSACH='$hinhanh' ,MOTA='$mota' ,MATACGIA='$mtacgia' ,MALOAISACH='$mloaisach', MALINHVUC='$mlinhvuc' ,GIAMUA='$giamua' WHERE MASACH='$ma';";
...
echo $twig->render('backend/sach/edit.html.twig', ['sach' => $loaisanphamRow] );