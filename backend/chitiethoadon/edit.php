...
$mhd = $_GET['cthd_mhd'];
$sqlSelect = "SELECT * FROM `chitiethoadon` WHERE MAHOADON='$mhd';";
...
if(isset($_POST['btnSave'])) 
{
    ...
    $mhd = $_POST['cthd_mhd'];
    $ms = $_POST['cthd_ms'];
    $soluong = $_POST['cthd_sl'];
    $mucgiamgia = $_POST['cthd_mgg'];

    // Câu lệnh UPDATE
    $sql = "UPDATE 'chitiethoadon' SET SOLUONG='$soluong'  WHERE MAHOADON='$mhd';";
...
echo $twig->render('backend/chitiethoadon/edit.html.twig', ['chitiethoadon' => $loaisanphamRow] );